...
export function TopHeader({
  ...
  return (
    <header className="no-print sticky top-0 z-20 hidden border-b border-ink-200 bg-white/85 backdrop-blur lg:block">
      {/* Хуудасны гарчгийг PageHeader эзэмшинэ. Энд давхардуулбал нэг дэлгэц
          дээр хоёр гарчиг гарна — тиймээс толгой мөр нь зөвхөн нэвтэрсэн
          хэрэглэгчийг харуулна. */}
      <div className="flex h-14 items-center justify-end gap-4 px-6 xl:px-8">
